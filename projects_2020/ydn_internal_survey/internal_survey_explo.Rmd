...
### Financial Aid and Income Breakdown (put side by side)
...
income_breakdown <- d %>%
  ...
  arrange(factor(household_income, levels = c("< $65,000", "$65,000 to $100,000", "$100,000 to $150,000", "$150,000 to $200,000", "$200,000 to $250,000", "$250,000 to $500,000", "> $500,000"), ordered = TRUE))
  
income_breakdown %>%
  ggplot(aes(x = "", y = prop, fill=household_income)) +
...
fin_aid_summary %>%
  ...
  theme(legend.title = element_blank()) +
  ggtitle("Financial Aid Received from Yale") +
  theme(plot.title = element_text(hjust = 0.5))
